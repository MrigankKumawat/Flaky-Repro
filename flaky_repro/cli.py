    ...
    if mode == "Sequential":
        ...
        sequential = {
            ...
            "failure_evidence": {
                ...
                "observed_min": round(min_val_sequential, 2),
                "observed_max": round(max_val_sequential, 2),
            },
        }
    ...
    if mode == "Parallel":
        ...
        parallel = {
            ...
            "failure_evidence": {
                ...
                "observed_min": round(min_val_parallel, 2),
                "observed_max": round(max_val_parallel, 2),
            },
        }
